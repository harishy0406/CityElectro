...
/**
 * Dialog for updating existing products
 */
public class UpdateProductDialog extends Dialog {
    ...
    public UpdateProductDialog(Frame parent, StoreService storeService, Product product) {
    ...
    private void initializeComponents() {
        titleLabel = new Label("Update Product", Label.CENTER);
        titleLabel.setFont(new Font("Arial", Font.BOLD, 16));

        idLabel = new Label("Product ID:");
        idField = new TextField(25);
    ...
    private void updateProduct() {
        ...
        try {
            ...
            // Show acknowledgment
            AcknowledgmentDialog.showMessage(this, "Product Updated Successfully!",
